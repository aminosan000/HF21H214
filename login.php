	...
	<nav class="navigation orange darken-2" role="navigation">
		<div class="nav-wrapper container"> <a href="./" class="brand-logo white-text left brand-logo-font hide-on-med-and-down">Instagourmet</a> <a href="./" class="brand-logo white-text center brand-logo-font hide-on-large-only">Instagourmet</a> 
			...
			<ul class="hide-on-med-and-down right">
				<li> <a href="index.php" class="hide-on-med-and-down"><i class="material-icons">home</i></a> </li>
				...
				<div class="card">
					<form method="post" action="./php/loginfunc.php">
						...
						<div class="card-action center">
							<button class="waves-effect waves-light btn-large orange darken-2" type="submit" name="action"> <i class="material-icons left">lock_open</i>ログイン </button>
						</div>
					</form>
					<?php
			if(isset($_GET['err'])){
