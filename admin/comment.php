			...
			<table class="bordered">
				<thead>
					<tr>
						...
						<th data-field="userId">コメント<br>ユーザID</th>
						<th data-field="commentDate">コメント<br>日時</th>
						<th data-field="comment">コメント内容</th>
					</tr>
				</thead>
				<tbody>
				<?php
					...
					foreach($commentArray as $commentRow){
						$imageName = $commentRow->getImageName();
						$userId = $commentRow->getUserId();
						$commentDate = $commentRow->getCommentDate();
						$comment = $commentRow->getComment();
				?>
					<tr>
						<td><?=$imageName?></td>
						<td><?=$userId?></td>
